...
/* customkey: footer logo */
import ossLogoPng from 'images/uni_logo.png';

const Footer = ({layoutHasSidebar = false}: {layoutHasSidebar: boolean}) => (
  <footer
    css={{
      backgroundColor: colors.uni_black, /* customkey: footer color */
      color: colors.white,
      paddingTop: 10,
      paddingBottom: 50,
    ...
    <Container>
      <div
        ...
        <section
          ...
          <a
            href="https://unicommerce.com" /* customkey: footer logo link */
            target="_blank"
            rel="noopener">
            <img
              alt="Unicommerce Website"
              css={{
                maxWidth: 160,
                height: 'auto',
              }}
          ...
          <p
            css={{
              color: colors.subtleOnDark, /* customkey: text color of footer statement */
              paddingTop: 15,
            }}>
              {/* customkey: copyright statement footer */}
            {`Copyright © ${new Date().getFullYear()} Unicommerce eSolutions Pvt. Ltd.`}
          </p>
        </section>
      </div>
    </Container>
