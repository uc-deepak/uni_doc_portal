...
const colors = {
  /* lighter: '#373940', // light blue 373940
  dark: '#282c34', // dark blue
  darker: '#20232a', // really dark blue
  brand: '#61dafb', // electric blue
  brandLight: '#bbeffd', */
  lighter: '#373940', // light blue - click highlight for header nav buttons and search bar
  dark: '#282c34', // dark blue -  page heading, homepage tagline
  darker: '#1E1E1C', // really dark blue
  brand: '#61dafb', // electric blue
  brandLight: '#bbeffd',
